...
Memo and search attributes are available in the Go client in [StartWorkflowOptions](https://godoc.org/go.temporal.io/temporal/internal#StartWorkflowOptions).
...
When using the Temporal Go client, provide key-value pairs as SearchAttributes in [StartWorkflowOptions](https://godoc.org/go.temporal.io/temporal/internal#StartWorkflowOptions).
